...
React 프론트엔드 지원용 **Next.js 백엔드 API 서버** 정리 문서입니다.
...
객체 ↔ 데이터베이스를 연결하여 SQL 없이 메서드로 DB 제어 가능
...
4️⃣ 미들웨어 (Middleware)
Middleware: 요청 전 공통 처리
(인증, CORS, 로깅 등)

Route Handler: 실제 API 로직 처리 (CRUD)
